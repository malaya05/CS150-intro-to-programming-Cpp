 ...
 * @author Steve G.
 * @version FALL 2013
 * This is the header file. Combine with cs150io.hxx file.
 */
#ifndef CS150CHECK_H
#define CS150CHECK_H
 ...
 * @param msg the message to print
 */
void _failReport(const std::string& msg, int pts = 1);
...
bool isMImpl(int target, const vector<int>& weights, int size, int index);
bool isM(int target, const vector<int>& weights);
...
#define assertDoubleEquals(e, a, t) (_assertEquals(#e, e, a, t))
#define assertDoubleEqualsMsg(m, e, a, t) (_assertEquals(m, #e, e, a, t))
