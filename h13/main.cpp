...
#else
    cerr << "Define the Point structure. Then, uncomment #define POINT_DONE in h13.h" << endl;
#endif
...
#else
    cerr << "Define the Triangle structure. Then, uncomment #define TRIANGLE_DONE in h13.h" << endl;
#endif
