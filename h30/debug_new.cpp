...
/**
 * Flag to control report whether delete[] called after new.
 */
bool array_delete_after_new = false;

/**
 * Flag to control report whether delete called after new[].
 */
bool delete_after_array_new = false;
...
{
    delete_after_array_new = array_delete_after_new = false;
